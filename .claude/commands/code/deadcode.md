...
- Medium/large scope (10+ functions): Use Task(subagent_type:go-editor), split into batches if 50+
- Preserve surrounding code structure and unrelated comments
...
- Use Task(subagent_type:go-editor) for test cleanup
...
- Use go-editor for bulk removals (10+ functions)
